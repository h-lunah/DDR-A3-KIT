...
t[#t+1] = Def.ActorFrame{
	StartSelectingStepsMessageCommand=function(s) s:AddChildFromPath(THEME:GetPathB("ScreenSelectCourse","overlay/TwoPartDiff")) end,
...
for _,pn in pairs(GAMESTATE:GetEnabledPlayers()) do
	t[#t+1] = LoadActor(THEME:GetPathG("ScreenSelectMusic","CourseContentsList"))..{
