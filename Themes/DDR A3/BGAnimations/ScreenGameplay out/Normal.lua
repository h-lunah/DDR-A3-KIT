...
return Def.ActorFrame{
    Def.Actor{
        ...
        UpdateFailedStateCommand=function(s)
			...
			if failed == true then
				...
				s:GetParent():GetChild("BackgroundSprite"):Load(THEME:GetPathG("","_doors/background_red"))
			else
				s:queuecommand("On")
			end
        end
    ...
    Def.Sprite{
        ...
        Texture=failed == false and BackgroundCleared() or THEME:GetPathG("","_doors/background_red"),
